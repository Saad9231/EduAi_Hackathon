...
export default function AuthPage() {
  ...
  const roles = [
    {
      ...
      activeBg: "bg-purple-500/20 border-purple-500 neon-border-purple"
    },
    {
      id: "teacher" as Role,
      title: "Teacher",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-950 p-4">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-600/20 blur-[120px] rounded-full mix-blend-screen animate-pulse-slow" />
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-0 glass-card border border-slate-800/50 overflow-hidden relative z-10 shadow-2xl rounded-2xl">
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-between bg-slate-900/80 border-r border-slate-800/50 hidden md:flex relative overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-purple-900/20 via-slate-900/0 to-transparent pointer-events-none" />
          
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-12">
              <div className="w-12 h-12 rounded-xl bg-purple-500 flex items-center justify-center neon-border-purple shadow-lg">
                <Bot className="w-7 h-7 text-white" />
              </div>
              <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-violet-500">
                EduAI
              </span>
            </div>
            
            <h1 className="text-3xl lg:text-4xl font-bold text-white mb-6 leading-tight">
              Unlock Your <br/> <span className="text-purple-400">Learning Potential</span>
            </h1>
          ...
          <div className="flex items-center gap-2 text-sm font-medium text-purple-400 bg-purple-500/10 w-max px-4 py-2 rounded-full border border-purple-500/20 relative z-10 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center bg-slate-900/40 relative">
            ...
            <div className="animate-in fade-in slide-in-from-right-8 duration-500 flex flex-col h-full justify-center">
              ...
              <div className="flex flex-col gap-4 mt-auto">
                ...
                <p className="text-center text-sm text-slate-400">
                  Already have an account? <button onClick={() => setMode("login")} className="text-purple-400 hover:text-purple-300 font-semibold underline decoration-purple-500/30 underline-offset-4">Log in</button>
                </p>
              </div>
            </div>
          )}
              ...
              <form onSubmit={handleAuthSubmit} className="flex flex-col gap-5">
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl py-3 pl-11 pr-4 text-sm text-slate-200 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all placeholder:text-slate-500"
                  />
                </div>
                ...
                <button 
                  type="submit"
                  disabled={isLoading}
                  className="w-full py-3.5 mt-2 rounded-xl bg-purple-500 hover:bg-purple-400 text-white font-bold transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:shadow-[0_0_25px_rgba(168,85,247,0.5)] flex items-center justify-center disabled:opacity-70"
                >
                  {isLoading ? (
          ...
          {mode === "login" && (
            <div className="animate-in fade-in slide-in-from-left-8 duration-500 flex flex-col h-full justify-center">
              ...
              <p className="text-center text-sm text-slate-400 mt-8">
                Don&apos;t have an account? <button onClick={() => setMode("role-select")} className="text-purple-400 hover:text-purple-300 font-semibold underline decoration-purple-500/30 underline-offset-4">Sign up</button>
              </p>
            </div>
          )}
