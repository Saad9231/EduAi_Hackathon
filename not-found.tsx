  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-6">
      ...
      <div className="glass-card p-8 sm:p-12 max-w-lg w-full text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-purple-500 hover:bg-purple-400 text-white font-bold transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)]"
        >
